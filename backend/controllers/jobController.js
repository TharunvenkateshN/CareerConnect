...
exports.getJobs = async (req, res) => {
    ...
    if (minSalary || maxSalary) {
        ...
        if (minSalary) {
            query.$and.push({ "salary.max": { $gte: Number(minSalary) } });
        }

        if (maxSalary) {
            query.$and.push({ "salary.min": { $lte: Number(maxSalary) } });
        }
...
exports.getJobsEmployer = async (req, res) => {
    try {
        console.log("getJobsEmployer called for user:", req.user ? req.user._id : "No user");
